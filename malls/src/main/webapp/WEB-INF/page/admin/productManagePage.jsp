...
<div class="table_normal_div">
    <table class="table_normal" id="table_product_list">
        ...
        <c:forEach items="${requestScope.productList}" var="product">
            <tr>
                <td><input type="checkbox" class="cbx_select" id="cbx_product_select_${product.productId}"><label
                        for="cbx_product_select_${product.productId}"></label></td>
                ...
                <td>
                    <c:choose>
                        <c:when test="${product.productIsEnabled==0}"><span class="td_success"
                                                                            title="产品正常销售中">销售中</span></c:when>
                        <c:when test="${product.productIsEnabled==2}"><span class="td_warn"
